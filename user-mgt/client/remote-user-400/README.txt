This contains a sample client to demo the remote user management service that expose carbon the user store manager 
as a web service. You can use this web service for authentication and do user and role management functions.
This project contains a web service client source can be used to call this web service.  
Also basically you can use this code as bridge for your own application and the web service.
